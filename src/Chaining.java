...
public class Chaining {
    ...
    public int insertKey(int key){
        //TODO: implement this and change the return statement
        int hashed = chain(key);
        // # of collisions equals to the size of the stored ArrayList.
        int collision = Table.get(hashed).size();
        // Add the key at the head of the ArrayList.
        Table.get(hashed).add(0,key);
        return collision;
    }
